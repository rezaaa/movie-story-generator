    ...
    return (
      <div className={styles.main}>
                  ...
                  return (
                    ...
                    >
                      <img
                        src={
                          item.poster_path
                            ? posterUrl300 + item.poster_path
                            : require("../../assets/images/defaultPoster.jpg")
                        }
                      />
        ...
        <Modal
          ...
          genres={{ movie: movieGenres, tv: tvGenres }}
          open={this.state.modalIsOpen}
          handleClose={this.handleModalClose}
        />
        <div className={styles.footer}>
          Created by{" "}
          <a href="https://www.instagram.com/_rezamahmoudii/" target="_blank">
          ...
          <div className={styles.github}>
            <a
              ...
              aria-label="Star rezaaaa/story-generator on GitHub"
            >
              Star
            </a>
            <a
              className="github-button"
              href="https://github.com/rezaaa/movie-story-generator/fork"
              data-icon="octicon-repo-forked"
              data-show-count="true"
              aria-label="Fork rezaaa/story-generator on GitHub"
            >
              Fork
            </a>
          </div>
...
function mapStateToProps(state) {
  const { movies, movieGenres, tvGenres, trending } = state;
  return {
    movies,
    notFound:
      movies.movieTitle &&
      movies.movieTitle.length > 0 &&
      !movies.fetching &&
      movies.results &&
      movies.results.total_results == 0,
    movieGenres:
      (movieGenres && movieGenres.results && movieGenres.results.genres) ||
      null,
    tvGenres: (tvGenres && tvGenres.results && tvGenres.results.genres) || null,
    trends:
      (trending && trending.results && trending.results.trends.slice(0, 4)) ||
      null
  };
}
