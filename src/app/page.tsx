...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-background overflow-x-hidden flex flex-col">
      {/* Hero Section - Takes available space on mobile */}
      <div className="relative flex-1 flex flex-col min-h-[50vh] sm:min-h-0 sm:flex-none">
        <div className="absolute inset-0 bg-gradient-to-b from-primary/5 via-transparent to-transparent" />
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[500px] sm:w-[800px] h-[500px] sm:h-[800px] bg-primary/10 rounded-full blur-3xl -translate-y-1/2" />

        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-20 pb-6 sm:pb-16 flex-1 flex flex-col justify-center">
          {/* Logo & Title */}
          <div className="text-center mb-6 sm:mb-12">
            <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-xl sm:rounded-2xl bg-gradient-to-br from-primary to-primary/50 mb-4 sm:mb-6 shadow-lg shadow-primary/25">
      ...
      {/* Footer */}
      <footer className="border-t border-border mt-6 sm:mt-16 py-4 sm:py-8">
